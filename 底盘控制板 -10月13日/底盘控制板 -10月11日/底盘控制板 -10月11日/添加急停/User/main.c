...
int16_t filter1(uint16_t x) 
{
    static int16_t buffer[N1] = {0};
...
int16_t filter2(uint16_t x) 
{
    static int16_t buffer[N2] = {0};
    static int16_t sum = 0;
    static int ptr = 0;
    sum = sum - buffer[ptr] + x;
    buffer[ptr] = x;
...
int16_t filter3(uint16_t x) 
{
    static int16_t buffer[N3] = {0};
    static int16_t sum = 0;
    static int ptr = 0;
    sum = sum - buffer[ptr] + x;
    buffer[ptr] = x;
...
int16_t filter4(uint16_t x) 
{
    static int16_t buffer[N4] = {0};
    static int16_t sum = 0;
    static int ptr = 0;
    sum = sum - buffer[ptr] + x;
    buffer[ptr] = x;
...
//			sprintf((char *)_sData.msg, "$|%d|\n", (int)(Car_Motion.Accumulation_X+1)); 
//			xQueueSend(xMyQueueHandle, &_sData, 0);
...
//			 sprintf((char *)_sData.msg(char *)_sData.msg, "L:%f R:%f", Car_Motion.AngleA, Car_Motion.AngleB);
			 sprintf((char *)_sData.msg, "LF:%d LB:%d RF:%d RB:%d\n",Lazer.Left_Front,Lazer.Left_Back, Lazer.Right_Front, Lazer.Right_Back);
			 xQueueSend(xMyQueueHandle, &_sData, 0);
			 sprintf((char *)_sData.msg, "LF:%d LB:%d RF:%d RB:%d\n",1,2, 3,4);
			 xQueueSend(xMyQueueHandle, &_sData, 0);
...
//        }				
				...
				{
				sprintf((char *)_sData.msg, "!|1|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x32)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|2|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x33)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|3|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x34)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|4|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x35)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|5|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x36)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|6|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x37)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|7|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x38)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|8|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x39)&&(data2[6]==0xFE))
				{
				sprintf((char *)_sData.msg, "!|9|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x31)&&(data2[6]==0x30))
				{
				sprintf((char *)_sData.msg, "!|10|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x31)&&(data2[6]==0x31))
				{
				sprintf((char *)_sData.msg, "!|11|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
				}	
				if((data2[3]==0x65)&&(data2[4]==0x6E)&&(data2[5]==0x31)&&(data2[6]==0x32))
				{
				sprintf((char *)_sData.msg, "!|12|\n"); 
 				xQueueSend(xMyQueueHandle, &_sData, 0);
//				printf("\r\n");
				}
...
//	LED2_ON();
	...
	Lazer.Left_Front_Offset = 61 - Lazer.Left_Front;
	Lazer.Left_Back_Offset = 61 - Lazer.Left_Back;
	Lazer.Right_Front_Offset = 61 - Lazer.Right_Front;
	Lazer.Right_Back_Offset = 61 - Lazer.Right_Back;
	delay_ms(100);//vTaskDelay(100);
//	LED2_OFF();
}
...
//			printf("1\n");
			...
			Lazer.Right_Front = buffer;//filter1(buffer);
		vTaskDelay(5);	
		Lazer_Average();
...
//			printf("2\n");
			...
			Lazer.Right_Back = buffer;//filter2(buffer);
		vTaskDelay(5);	
		Lazer_Average();
...
//			printf("3\n");
		...
		Lazer.Left_Front = buffer;//filter3(buffer);
		vTaskDelay(5);	
		Lazer_Average();
...
//			printf("4\n");
			...
			Lazer.Left_Back = buffer;//filter4(buffer);
		vTaskDelay(15);	
		Lazer_Average();
	}
}
