...
#define               macRC522_GPIO_RST_CLK                     RCC_APB2Periph_GPIOC
#define               macRC522_GPIO_RST_PORT    	              GPIOC	   
#define               macRC522_GPIO_RST_PIN		                  GPIO_Pin_4
#define               macRC522_GPIO_RST_Mode		                GPIO_Mode_Out_PP



/*********************************** RC522 函数宏定义*********************************************/
#define          macRC522_SDA_0          GPIO_ResetBits ( macRC522_GPIO_SDA_PORT, macRC522_GPIO_SDA_PIN )
#define          macRC522_SDA_1          GPIO_SetBits ( macRC522_GPIO_SDA_PORT, macRC522_GPIO_SDA_PIN )

#define          macRC522_Reset_0      GPIO_ResetBits( macRC522_GPIO_RST_PORT, macRC522_GPIO_RST_PIN )
#define          macRC522_Reset_1     GPIO_SetBits ( macRC522_GPIO_RST_PORT, macRC522_GPIO_RST_PIN )
