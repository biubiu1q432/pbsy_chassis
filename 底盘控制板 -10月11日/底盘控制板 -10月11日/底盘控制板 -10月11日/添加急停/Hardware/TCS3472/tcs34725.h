...
//#define TCS_SDA_IN()  {GPIOB->CRH &= 0xFFFF0FFF; GPIOB->CRH |= 8 << 12;} // Configure PB13 as input
//#define TCS_SDA_OUT() {GPIOB->CRH &= 0xFFFF0FFF; GPIOB->CRH |= 3 << 12;} // Configure PB13 as output
#define TCS_SDA_READ  (GPIOB->IDR & (1 << 13)) // Read from PB13 (TCS_SDA)

#define TCS_SCL_H     GPIO_SetBits(GPIOB, GPIO_Pin_12) // Set PB12 high (TCS_SCL)
#define TCS_SCL_L     GPIO_ResetBits(GPIOB, GPIO_Pin_12) // Set PB12 low (TCS_SCL)
#define TCS_SDA_H     GPIO_SetBits(GPIOB, GPIO_Pin_13) // Set PB13 high (TCS_SDA)
#define TCS_SDA_L     GPIO_ResetBits(GPIOB, GPIO_Pin_13) // Set PB13 low (TCS_SDA)
